...
def test_login_successful():
    ...
    response = client.post(
        "/login", json={"username": "DataD", "password": "password123"}
    )
...
def test_login_nonexistent_user():
    ...
    response = client.post(
        "/login", json={"username": "nonexistent_user", "password": "password123"}
    )
...
def test_create_lobby_nonexistent_host_player():
    ...
    response = client.post(
        "/create-lobby", json={"hostplayerID": 999}
...
def test_join_lobby_successful():
    ...
    response = client.post("/join-lobby", json={"playerId": 1, "lobbyId": 2})
...
def test_join_lobby_nonexistent_player():
    ...
    response = client.post("/join-lobby", json={"playerId": 999, "lobbyId": 2})
...
def test_deal_cards_successful():
    ...
    response = client.post("/deal-cards", json={"lobby_id": 1})
...
def test_deal_cards_nonexistent_lobby():
    ...
    response = client.post("/deal-cards", json={"lobby_id": 999})
