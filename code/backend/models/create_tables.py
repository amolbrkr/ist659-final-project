from models import *
from sqlalchemy import create_engine, Column, Integer, String, Numeric, Date, Float, inspect
...
if not missing_tables:
    ...
    print(f"Anomaly detected! The following tables are missing from the database: {missing_tables}")
